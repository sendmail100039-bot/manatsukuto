...
export default async function AdminIndex() {
  ...
  const items = [
    ...
    { href: "/manager/shift-patterns", label: "シフトパターン", desc: "早番・日勤・遅番などの勤務時間帯", show: hasPermission(p, "shift.manage") },
    { href: "/manager/leave?tab=admin", label: "休暇種別・付与", desc: "休暇種別と年度ごとの付与日数", show: hasPermission(p, "leave.admin") },
